...
export const Licenses: React.FC<LicensesProps> = ({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/80 p-6 rounded-2xl border border-slate-800 shadow-md backdrop-blur-xs">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold text-white tracking-tight">Gestión de Licencias Médicas</h1>
            <span className="text-xs bg-blue-500/15 text-blue-300 font-semibold px-2.5 py-0.5 rounded-full border border-blue-500/30">
              Mis Licencias ABC
            </span>
          </div>
