...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* Profile Header Card */}
      <div className="bg-slate-900/80 rounded-2xl border border-slate-800 shadow-md overflow-hidden backdrop-blur-xs">
        {/* Cover Accent */}
        <div className="h-32 bg-gradient-to-r from-blue-950 via-slate-900 to-indigo-950 border-b border-blue-900/40 relative">
          <div className="absolute right-4 bottom-3 bg-slate-900/80 backdrop-blur-xs text-blue-300 text-xs px-3 py-1 rounded-full border border-blue-500/30 font-medium">
            Agente Activo DGCyE
          </div>
        </div>
        ...
        <div className="px-6 pb-6 pt-0 relative">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-12 mb-4">
            ...
            <div className="flex items-end gap-4">
              <div className="w-24 h-24 rounded-2xl bg-blue-900 text-white font-extrabold text-2xl flex items-center justify-center border-4 border-slate-900 shadow-xl">
                MR
              </div>
              <div className="mb-1">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl border border-slate-700 bg-slate-800 text-slate-200 text-xs font-semibold hover:bg-slate-700 transition shadow-sm self-start sm:self-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-3">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2">
                <Key className="w-4 h-4 text-blue-400" /> Identificación Institucional
              </h3>
            ...
            <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-3">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2">
                <GraduationCap className="w-4 h-4 text-blue-400" /> Establecimiento de Destino
              </h3>
          ...
          <div className="mt-6 border-t border-slate-800 pt-6">
            <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
              <Mail className="w-4 h-4 text-blue-400" /> Datos de Contacto y Notificaciones
            </h3>

            {isEditing ? (
              <form onSubmit={handleSaveProfile} className="space-y-4 max-w-lg bg-slate-950/70 p-4 rounded-xl border border-slate-800">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-800 text-slate-400 text-xs rounded-xl px-3 py-2 border border-slate-700"
                  />
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-900 text-white text-xs rounded-xl px-3 py-2 border border-slate-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  />
                </div>
